...
-- Automatic contract creation and reservation fulfillment are performed inside the existing
-- SERIALIZABLE rental agreement application transaction so deployment does not require MySQL SUPER privileges.
