...
| Large-tenant homeowner / finance / employee / document scale | YES bounded 5,001-homeowner, 2,001-row finance, 5,001-employee, and 5,001-document fixtures | PARTIAL | Employee search browser regression verified; document-library scale evidence in progress | PENDING | P0/P1 | IN_PROGRESS | PR #211-#213 merged; document-library pagination/search/isolation increment is in progress |
