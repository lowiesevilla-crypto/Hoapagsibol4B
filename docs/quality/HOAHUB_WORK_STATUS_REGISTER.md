...
| 5,000+ employee directory scale | P1 | IN_PROGRESS | Issue #196; active branch `test/large-tenant-employee-scale-20260827`; bounded server-side search/pagination, 5,001-row integration coverage, tenant-isolation denial, and browser search regression are in progress |
