...
export default async function PortalStatementOfAccountPage() {
  ...
  return <PortalPageContainer className="homeowner-soa-print space-y-6">
    <div className="print-hidden"><PaymentAreaNavigation active="soa" /></div>
    <PageHeader eyebrow="My account" title="Statement of Account" description="A tenant-scoped summary of your balances, payments, and billing activity." action={<div className="print-hidden flex flex-wrap gap-2"><Link className="btn-secondary" href="/portal/pay"><QrCode className="size-4" /> Pay dues</Link><SoaPrintButton /></div>} />
    ...
    <p className="print-hidden flex flex-wrap items-center gap-2 rounded-3xl bg-pine-50 p-4 text-sm font-semibold text-pine-900"><Download className="size-4" /> Use Print for the homeowner mobile statement. Official downloadable SOA PDF remains available through the HOA office.</p>
  </PortalPageContainer>;
}
