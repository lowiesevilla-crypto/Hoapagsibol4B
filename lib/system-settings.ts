...
export const settingSections: { category: SystemSettingCategory; title: string; description: string; fields: SettingField[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { category: SystemSettingCategory.EMAIL, key: "MAIL_DKIM_SELECTOR", label: "DKIM selector", help: "Provider DKIM selector used to verify selector._domainkey sender DNS before production email rollout.", placeholder: "default" },
