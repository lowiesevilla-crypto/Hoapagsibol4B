...
| Truthful action progress and duplicate-submission rollout | P0/P1 | IN_PROGRESS | Issue #273 / `HOAHUB-UX-P0-001`. Default-off, fail-closed foundation candidate adds shared progress/lock behavior and global/tenant/module/role targeting, with pilot wiring limited to Record Payment and monthly billing generation. No active tenant is enabled. Exact-head CI, staging/UAT, monitoring/rollback verification, and pilot authorization remain open. |
