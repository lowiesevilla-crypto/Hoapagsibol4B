...
| UI Wave 3: Collections / Payments / Receipts | P1 | IN_PROGRESS | Issue #231. Active branch `ui/wave3-collections-list-20260828` starts with Admin Collections list/search presentation from verified PR #230 merge `41a84494e7cc4564a152f685a23cf9b7969c4f4b`; payment posting/void/refund/allocation/settlement/accounting authority remains unchanged |
...
1. Continue UI Wave 3 under #231 with the Admin Collections list/search presentation as the next independently gated slice.
