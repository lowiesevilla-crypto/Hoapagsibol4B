...
5. Admin users with tenant roles review `/admin/complaints`. Platform roles are rejected from complaint content by service checks.
6. Status, message, assignment, identity access request, and timeline actions write append-only operational records.
