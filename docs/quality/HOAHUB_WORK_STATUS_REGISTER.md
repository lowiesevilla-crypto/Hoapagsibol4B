...
| High-volume bills / payments / collections QA pack | P1 | IN_PROGRESS | Issue #196; active branch `test/high-volume-finance-pagination-20260827`; increment seeds 2,001 tenant-scoped rows per finance domain and verifies bounded last-page queries, counts, exact-reference isolation, and conservative CI timing |
