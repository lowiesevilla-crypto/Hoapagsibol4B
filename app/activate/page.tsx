    ...
    <main className="grid min-h-screen place-items-center bg-[#eef8fc] px-4 py-8">
      <section className="w-full max-w-md overflow-hidden rounded-[2rem] border border-pine-100 bg-white p-5 shadow-[0_24px_70px_rgba(8,97,141,.16)] sm:p-10">
        ...
        <p className="mb-6 mt-2 text-sm leading-6 text-slate-600">
          {handoffDetails
            ? "Your registered email and invitation are verified. Review the prefilled account number and temporary password, then enter your email and create your permanent password."
            : "Use the invitation link and temporary password sent by your HOA, then create your permanent password."}
        </p>
        {handoffDetails && <p className="mb-4 rounded-xl bg-emerald-50 px-3 py-2 text-sm font-semibold text-emerald-800">Registered email verified. Your account number and one-time temporary password were populated securely.</p>}
