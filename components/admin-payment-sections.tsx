...
export function PaymentRequestsView({ data, query }: { data: Awaited<ReturnType<typeof getPaymentRequestsData>>; query: PaymentQuery }) {
  return <>
    ...
    <section className="card mb-6">
      ...
      <StandardTable mode="managed"><div className="table-wrap shadow-none"><table className="data-table"><thead><tr><th>Homeowner</th><th>Purpose</th><th>Reference</th><th>Attachment</th><th>Status</th><th>Submitted</th><th className="text-right">Amount</th><th></th></tr></thead><tbody>
...
export function ActivePaymentsView({ data, query }: { data: Awaited<ReturnType<typeof getActivePaymentsData>>; query: PaymentQuery }) {
  return <>
    ...
    <StandardTable mode="managed"><div className="table-wrap"><table className="data-table"><thead><tr><th>Receipt / reference</th><th>Homeowner</th><th>Payment Coverage</th><th>Payment date</th><th>Method</th><th>Proof</th><th>Controlled amount update</th><th>Actions</th></tr></thead><tbody>
