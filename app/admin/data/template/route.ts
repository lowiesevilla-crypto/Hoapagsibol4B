...
function sampleRow(type: MasterDataType) {
  const rows: Record<MasterDataType, string[]> = {
    homeowners: ["Juan Dela Cruz", "juan@example.com", "ChangeMe123!", "09170000000", "Block 1 Lot 1 Pagsibol Village", "1", "1", "", "ACTIVE", "1000"],
