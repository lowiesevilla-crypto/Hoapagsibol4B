...
export default async function PortalPaymentsPage() {
  ...
  const payments = await prisma.payment.findMany({ where: { homeownerId: profile.id, status: "ACTIVE" }, include: { bill: true, allocations: { include: { bill: true }, orderBy: { bill: { billingMonth: "asc" } } } }, orderBy: [{ paymentDate: "desc" }, { createdAt: "desc" }] });
