...
async function main() {
  ...
  assert(rendered.content.includes("color:#163B72") && rendered.content.includes("color:#dc2626") && rendered.content.includes("bona fide resident") && rendered.content.includes("Test HOA"), "selected-range color and resolved content survive preview rendering");
