...
export function PaymentHistoryView({ data, query }: { data: Awaited<ReturnType<typeof getPaymentHistoryData>>; query: PaymentQuery }) {
  return <>
    ...
    <Pager page={data.historyPage} count={data.paymentCount} pageSize={paymentPageSize} pageKey="historyPage" preserved={preservedEntries(query, ["historyPage"])} basePath="/admin/payments/history" />
  </>;
}
