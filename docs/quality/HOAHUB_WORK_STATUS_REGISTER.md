...
|---|---:|---|---|
| Protect post-rollback production baseline | P0 | VERIFIED | Current verified `main` includes Petty Cash PR #198, Payment Void PR #200, Refund PR #202, Online Payments PR #204, Financial Reports PR #206, quality/scale/browser evidence through #222, UI Waves 1–5, and final Wave 5 Attendance merge `92cccb29a73391c4928480a60fbfa360e3302c48`; post-merge HOAHub MySQL CI #1335 passed including production smoke/critical browser suite and managed-production/public-health verification. |
...
| UI Wave 4: Documents | P1 | VERIFIED | Issue #235 completed. Actual product slices merged through Document Templates PR #243; final Wave 4 release baseline `14654f0e79e23ef5f682226bf85f41c7d1b1c278` passed post-merge MySQL CI #1327. Documentation-only PRs #236/#237 are not counted as product implementation. |
| UI Wave 5: Operations | P1 | VERIFIED | Issue #244 completed. Complaints PR #245, Vehicles #246, Contractors #247, and Attendance #248 each passed exact-head MySQL + Canva + Edge + Firefox + Mobile gates; final Attendance exact head `b563faa8b8b8adeb6c06ca0413f08f880f955cb1` merged as `92cccb29a73391c4928480a60fbfa360e3302c48`, with post-merge MySQL CI #1335 PASS. |
| UI Wave 6: Finance / Reports / Rental | P1 | IN_PROGRESS | Issue #249. Finance Reports presentation is active from verified `main` `92cccb29a73391c4928480a60fbfa360e3302c48`; next slices are Expenses and Rental-Reconciliation. Preserve all finance/report/payment/rental calculations and authority. |

## Immediate Execution Order

1. Complete Wave 6 Finance Reports presentation under #249 from verified `main` `92cccb29a73391c4928480a60fbfa360e3302c48`; merge only after exact-head MySQL CI + Canva Visual Parity + Edge + Firefox + Mobile gates pass.
2. Verify post-merge `main` release health, then proceed to Expenses followed by Rental-Reconciliation as separately gated slices.
