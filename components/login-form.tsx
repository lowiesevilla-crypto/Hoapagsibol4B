...
export function LoginForm() {
  ...
  return (
    <form action={action} className="space-y-4">
      ...
      <div className="flex justify-end"><Link className="text-sm font-bold text-pine-700 hover:text-pine-900 hover:underline" href="/forgot-password">Forgot password?</Link></div>
