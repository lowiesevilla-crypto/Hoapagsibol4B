...
export function PlatformTenantTabs({ tenantId, active }: { tenantId: string; active: string }) {
  const tabs = [{ key: "overview", label: "Overview", href: `/platform/tenants/${tenantId}` }, { key: "users", label: "Users", href: `/platform/tenants/${tenantId}/users` }, { key: "settings", label: "Settings", href: `/platform/tenants/${tenantId}#settings` }, { key: "modules", label: "Module Access", href: `/platform/tenants/${tenantId}#modules` }, { key: "advisory", label: "Advisory", href: `/platform/tenants/${tenantId}#advisory` }, { key: "audit", label: "Audit Log", href: `/platform/tenants/${tenantId}/audit` }];
