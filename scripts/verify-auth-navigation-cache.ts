...
async function main() {
  ...
  assert(authButtons.includes("event.preventDefault()") && authButtons.includes("HTMLFormElement.prototype.submit.call(form)"), "Logout must suppress React/Next delegated default submission and invoke the native form algorithm exactly once.");
