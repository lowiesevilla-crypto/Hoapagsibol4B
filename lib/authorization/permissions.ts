...
export const Permission = {
  ...
  AI_ASSISTANCE_USE: "ai_assistance.use",
  AI_ASSISTANCE_MANAGE: "ai_assistance.manage",
  AI_KNOWLEDGE_MANAGE: "ai_assistance.knowledge_manage",
  AI_AUDIT_READ: "ai_assistance.audit_read",
...
const tenantAdministratorPermissions: readonly Permission[] = [
  ...
  Permission.AI_ASSISTANCE_USE,
  Permission.AI_ASSISTANCE_MANAGE,
  Permission.AI_KNOWLEDGE_MANAGE,
...
export const defaultRolePermissions: Readonly<Record<Role, readonly Permission[]>> = {
  ...
  EMPLOYEE: [Permission.EMPLOYEE_PORTAL_ACCESS, Permission.AI_ASSISTANCE_USE, Permission.CHAT_USE],
};
