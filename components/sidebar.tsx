  ...
  return (
    <aside className={asideClassName}>
      ...
      <div className="hidden border-t border-white/10 bg-black/5 p-4 lg:absolute lg:inset-x-0 lg:bottom-0 lg:block">
        ...
        <LogoutButton className="flex w-full items-center gap-2 rounded-xl px-2 py-2 text-xs font-bold text-pine-100 hover:bg-white/10" />
      </div>
    </aside>
  );
}
