...
export default async function PortalComplaintsPage() {
  ...
  return <>
    <PageHeader eyebrow="Homeowner services" title="My Complaints" description="Review named complaints submitted through your homeowner account." action={<Link className="btn-primary" href="/portal/complaints/new">Submit complaint</Link>} />
    ...
    <section className="card p-0 sm:p-0">
      ...
      </tbody></table></div> : <div className="py-14 text-center text-sm text-slate-500">No named complaints have been submitted from your account.</div>}
    </section>
  </>;
}
