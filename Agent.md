...
- `tests/unit/browser-cleanup-policy.test.ts` protects controlled-browser ordering, the exact compatible dependency pair, shell launch mode, bounded retry behavior, and cleanup invariants.
