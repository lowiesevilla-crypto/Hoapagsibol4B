...
export const placeholderGroups: { group: string; items: { key: AllowedDocumentPlaceholder; label: string; sample: string }[] }[] = [
  ...
  { group: "Request", items: [
    ...
    { key: "request.passType", label: "Pass type", sample: "MOVE IN" },
    { key: "request.scheduledDate", label: "Scheduled date", sample: "July 31, 2026" },
    { key: "request.startTime", label: "Start time", sample: "08:00" },
    { key: "request.endTime", label: "End time", sample: "10:00" },
    { key: "request.driverName", label: "Driver name", sample: "Pedro Santos" },
    { key: "request.representativeName", label: "Representative", sample: "Pedro Santos" },
    { key: "request.vehicleDetails", label: "Vehicle details", sample: "White van ABC 1234" },
    { key: "request.destination", label: "Destination", sample: "Main gate" },
    { key: "request.movingCompany", label: "Moving company", sample: "Sample Moving Services" },
    { key: "request.serviceProvider", label: "Service provider", sample: "Sample Moving Services" },
    { key: "request.itemsSummary", label: "Items summary", sample: "1. 2 - Office chairs" },
    { key: "request.approvalDate", label: "Approval date", sample: "July 31, 2026" },
  ] },
