...
export function EmployeeForm({ employee }: { employee?: EmployeeProfile & { user?: { email: string } | null } }) {
  return <form action={saveEmployeeAction} className="card max-w-4xl space-y-6">
    ...
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      <Field label="Temporary password" name="loginPassword" type="text" defaultValue="ChangeMe123!" />
