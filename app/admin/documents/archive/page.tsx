...
export default async function DocumentArchivePage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <>
    <PageHeader eyebrow="Document management" title="Document archive" description="Soft-deleted requests and every immutable generated version remain available for audit and restoration." action={<Link className="btn-secondary" href="/admin/documents">Document Management</Link>} />
