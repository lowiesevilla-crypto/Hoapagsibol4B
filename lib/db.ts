...
const modelModules: Partial<Record<string, TenantModule>> = {
  ...
  LeaveType: TenantModule.PAYROLL,
  EmployeeLeaveBalance: TenantModule.PAYROLL,
  LeaveRequest: TenantModule.PAYROLL,
  LeaveBalanceTransaction: TenantModule.PAYROLL,
  ...
  FinancialJournalEntry: TenantModule.PAYROLL,
  FinancialJournalLine: TenantModule.PAYROLL,
  PayrollPostingOutbox: TenantModule.PAYROLL,
  PayrollFinancialPosting: TenantModule.PAYROLL,
  ...
  DocumentDefinition: TenantModule.DOCUMENTS,
  DocumentDefinitionField: TenantModule.DOCUMENTS,
  DocumentTemplateSet: TenantModule.DOCUMENTS,
  DocumentTemplateVersion: TenantModule.DOCUMENTS,
