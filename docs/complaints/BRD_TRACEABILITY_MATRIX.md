...
| CM-007 to CM-012 | Named, confidential, and anonymous complaint intake, including generated reference and requested action/outcome. | `components/complaint-intake-form.tsx`, `lib/services/complaints.ts`, `/portal/complaints/new`, `/complaints/track`, `Complaint.requestedAction`. |
| CM-013 to CM-018 | Status lifecycle, status history, timeline, assignment, reopen/close states, required reasons, and centralized transition policy. | `ComplaintStatus`, `ComplaintStatusHistory`, `ComplaintTimelineEvent`, `ComplaintAssignment`, `allowedComplaintTransitions`, `/admin/complaints/[id]`. |
...
| CM-031 to CM-036 | Homeowner named/confidential portal history and anonymous tracking without identity linkage. | `ComplaintTrackingCredential`, salted PIN hash, `getHomeownerComplaintList`, `getHomeownerComplaintDetail`, `trackAnonymousComplaint`, verification script identity-null checks. |
| CM-037 to CM-041 | Confidential identity separation, service-layer masking, and restricted disclosure workflow. | `ComplaintConfidentialIdentity`, `ComplaintIdentityAccessGrant`, `revealConfidentialIdentity`, confidential author masking, no-store reveal route. |
| CM-042 to CM-045 | Auditability, no unsafe exports, privacy-aware reporting, settings, operational UAT. | `writeAuditLog`, filtered/paginated aggregate reports, complaint settings, required docs and `verify:complaint-management`. |
...
- Dual approval, advanced redaction, exports, notification templates, retention/legal-hold automation, and real malware scanning remain deferred beyond this MVP remediation.
