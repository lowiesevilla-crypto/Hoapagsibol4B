...
export function TenantLoginScreen({ tenant, reset, loggedOut, universal = false }: { tenant: LoginTenant; reset?: string; loggedOut?: string; universal?: boolean }) {
  const features = [
