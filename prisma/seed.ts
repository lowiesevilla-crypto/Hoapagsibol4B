...
async function main() {
  ...
  const settings = [
    ...
    [SystemSettingCategory.EMAIL, "MAIL_PROVIDER", "Mail provider", "smtp"],
    [SystemSettingCategory.EMAIL, "MAIL_HOST", "SMTP host", "smtp.hostinger.com"],
    [SystemSettingCategory.EMAIL, "MAIL_PORT", "SMTP port", "465"],
    [SystemSettingCategory.EMAIL, "MAIL_ENCRYPTION", "Encryption", "ssl"],
    [SystemSettingCategory.EMAIL, "MAIL_USERNAME", "SMTP username", "support@hoahub.tech"],
    [SystemSettingCategory.EMAIL, "MAIL_FROM_NAME", "Sender name", "HOAHUB"],
    [SystemSettingCategory.EMAIL, "MAIL_FROM_ADDRESS", "Sender email", "support@hoahub.tech"],
