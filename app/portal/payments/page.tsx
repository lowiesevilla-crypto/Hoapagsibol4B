...
export default async function PortalPaymentsPage() {
  ...
  return <>
    <PageHeader eyebrow="My account" title="Payment and receipt history" description="Official monthly dues receipts recorded by the HOA for your household." />
    <p className="mb-4 text-sm font-bold text-pine-800">Available unapplied credit: {money(totalUnappliedCredit(payments))}</p>
    <div className="table-wrap"><StandardTable><table className="data-table"><thead><tr><th>Receipt / reference</th><th>Payment Coverage</th><th>Date</th><th>Method</th><th>Remarks</th><th>Proof</th><th className="text-right">Received</th><th className="text-right">Applied</th><th className="text-right">Credit</th><th></th></tr></thead><tbody>
      ...
      {!payments.length && <tr><td colSpan={10} className="py-12 text-center text-slate-500">No payments have been recorded for your account.</td></tr>}
