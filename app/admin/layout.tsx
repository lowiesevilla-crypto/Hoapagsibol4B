...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const requestedModule = moduleForPath((await headers()).get("x-hoa-pathname") || "/admin/dashboard");
  ...
  const links = filterLinksByModules(isSystemAdmin ? systemAdminLinks : adminLinks, enabledModules)
